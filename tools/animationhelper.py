...
def update_uv_clip_hash(clip_obj) -> bool:
    ...
    while temp_parent_obj.parent:
        ...
        if temp_parent_obj.sollum_type == SollumType.DRAWABLE or temp_parent_obj.sollum_type == SollumType.FRAGMENT or temp_parent_obj.sollum_type == SollumType.VISUAL_DICTIONARY:
