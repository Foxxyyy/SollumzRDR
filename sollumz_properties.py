...
class SollumType(str, Enum):
    ...
    VISUAL_DICTIONARY = "sollumz_visual_dictionary"
    FRAG_DRAWABLE = "sollumz_frag_drawable"
...
DRAWABLE_TYPES = [
    ...
    SollumType.VISUAL_DICTIONARY,
    SollumType.FRAG_DRAWABLE,
    SollumType.SKELETON,
]
...
SOLLUMZ_UI_NAMES = {
    ...
    SollumType.VISUAL_DICTIONARY: "Visual Dictionary",
    SollumType.FRAG_DRAWABLE: "Frag Drawable",
    ...
    AssetType.VISUAL_DICTIONARY: "Visual Dictionary",
    AssetType.FRAG_DRAWABLE: "Frag Drawable",
...
def register():
    ...
    bpy.types.Scene.debug_sollum_type = bpy.props.EnumProperty(
        items=[(SollumType.DRAWABLE.value, SOLLUMZ_UI_NAMES[SollumType.DRAWABLE], SOLLUMZ_UI_NAMES[SollumType.DRAWABLE]),
               (SollumType.VISUAL_DICTIONARY.value, SOLLUMZ_UI_NAMES[SollumType.VISUAL_DICTIONARY], SOLLUMZ_UI_NAMES[SollumType.VISUAL_DICTIONARY]),
               (SollumType.FRAG_DRAWABLE.value, SOLLUMZ_UI_NAMES[SollumType.FRAG_DRAWABLE], SOLLUMZ_UI_NAMES[SollumType.FRAG_DRAWABLE]),
               (SollumType.DRAWABLE_DICTIONARY.value, SOLLUMZ_UI_NAMES[SollumType.DRAWABLE_DICTIONARY], SOLLUMZ_UI_NAMES[SollumType.DRAWABLE_DICTIONARY]),
