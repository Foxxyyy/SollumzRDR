...
class ShaderManager:
    ...
    shaderxml_rdr1 = os.path.join(os.path.dirname(__file__), "Shaders_RDR1.xml")
    ...
    @staticmethod
    def load_shaders(shader_files):
        for shader_file in shader_files:
            tree = ET.parse(shader_file)
...
ShaderManager.load_shaders([ShaderManager.shaderxml, ShaderManager.shaderxml_rdr1])
